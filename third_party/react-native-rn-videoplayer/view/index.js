          ...
          <View
            ...
            <View>
              <Text style={{ color: '#fff' }}>
                {props.loadingText ? props.loadingText : '正在缓冲...'}
              </Text>
            </View>
          </View>
        </View>
...
export const TipsPaused = props => {
  let timer;
  const animater = useMemo(() => new Animated.Value(0), []);

  const [show, setShow] = React.useState(true);

  //控件显示动画
  const AnimatedOp = useMemo(
    () =>
      Animated.timing(
        // timing方法使动画值随时间变化
        animater, // 要变化的动画值
        ...
        <View
          ...
          <Animated.View
            style={{
              ...
              alignItems: 'center',
              justifyContent: 'center',
              transform: [{ rotateY: isSolTouch ? '180deg' : '0deg' }],
            }}>
