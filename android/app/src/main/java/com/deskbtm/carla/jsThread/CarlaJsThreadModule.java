...
public class CarlaJsThreadModule extends ReactContextBaseJavaModule implements LifecycleEventListener {
  ...
  public CarlaJsThreadModule(ReactApplicationContext rac, ReactNativeHost rnh) {
    super(rac);
    reactNativeHost = rnh;
