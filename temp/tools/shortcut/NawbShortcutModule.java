package com.deskbtm.nawb.tools.shortcut;
...
public class NawbShortcutModule extends ReactContextBaseJavaModule {
  
  private String TAG = "NawbShortcutModule";
  

  private final ReactApplicationContext reactApplicationContext;

  public NawbShortcutModule(ReactApplicationContext applicationContext) {
    ...
    try {
      ...
      Glide.with(reactApplicationContext).asBitmap().load(icon).into(new CustomTarget<Bitmap>() {
        ...
        public void onResourceReady(@NonNull Bitmap resource, @Nullable Transition<? super Bitmap> transition) {
          ...
          Intent shortcutIntent = new Intent(getReactApplicationContext(), NawbShortcutModule.class);
